#ifndef UTILITY_TEMPORAL_BUFFER_H_
#define UTILITY_TEMPORAL_BUFFER_H_
...
public:
    ...
    bool getOldestValue(int64_t& ts, ValueType* value) const;
    bool getNewestValue(int64_t& ts,ValueType* value) const;
